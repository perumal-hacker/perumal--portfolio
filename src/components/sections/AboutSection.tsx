...
const AboutSection: React.FC = () => {
  ...
  return (
    <section id="about" className="section-padding bg-white dark:bg-black/95">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative w-80 h-80 mx-auto">
              {/* Animated border */}
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-blue-800 dark:from-green-500 dark:via-blue-500 dark:to-purple-500 rounded-2xl animate-glow" />
              ...
              <div className="absolute -bottom-4 -right-4 bg-white dark:bg-gray-900 border border-blue-500/30 dark:border-green-500/30 rounded-lg p-3 font-mono text-xs text-blue-600 dark:text-green-400 shadow-lg">
                <div>{'{'}</div>
          ...
          >
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-6 font-mono text-sm">
                <div className="text-blue-600 dark:text-green-400 mb-4">~/about-me$ cat profile.txt</div>
                <div className="space-y-2 text-gray-700 dark:text-gray-300">
                  <div><span className="text-blue-500 dark:text-blue-400">▸</span> I'm a final-year Computer Science Engineering student specializing in the MERN stack</div>
                  <div><span className="text-green-500 dark:text-green-400">▸</span> Strong experience in DSA, backend development, and problem solving</div>
                  ...
                  <div><span className="text-yellow-500 dark:text-yellow-400">▸</span> Currently learning DBMS and database optimization techniques</div>
                  <div><span className="text-cyan-500 dark:text-cyan-400">▸</span> Building scalable applications with modern web technologies</div>
                  <div><span className="text-pink-500 dark:text-pink-400">▸</span> Passionate about creating efficient, maintainable code solutions</div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {highlights.map((item, index) => (
                <motion.div
                  ...
                  className="group bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-green-500/50 p-4 rounded-lg transition-all duration-300 hover:bg-gray-50 dark:hover:bg-gray-800/50 shadow-sm"
                >
            ...
            >
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 dark:from-green-600 dark:to-blue-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 dark:hover:from-green-700 dark:hover:to-blue-700 transition-all duration-300 font-medium"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-800 dark:text-white rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 font-medium"
              >
