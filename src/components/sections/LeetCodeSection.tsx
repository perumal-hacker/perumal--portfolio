...
const LeetCodeSection: React.FC = () => {
  ...
  if (leetcodeStats.loading || githubStats.loading) {
    return (
      <section id="leetcode" className="section-padding bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[...Array(6)].map((_, i) => (
              <Card key={i} className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-lg border-gray-200 dark:border-gray-700 animate-pulse shadow-xl">
